  ...
  return (
    <div className={`relative ${className}`} ref={dropdownRef}>
      <Select value={language} onValueChange={handleLanguageChange}>
        <SelectTrigger className="flex items-center justify-center px-2 py-2 rounded-lg  border border-transparent transition-colors duration-300 text-gray-700 dark:text-gray-200 hover:text-icon-text-primary dark:hover:text-icon-text-primary w-10 h-10 p-0">  {/* 0d3a34dfab3ba64cc649761b3fc15ab7 */}
          <Image
